...
checkpoint_path = "checkpoint_rad.pth"
...
if __name__ == "__main__":
    ...
    train_set = Jarvis2dSTEMDataset(image_data=train_data, label_mode="radius")
    val_set = Jarvis2dSTEMDataset(image_data=test_data, label_mode="radius")
